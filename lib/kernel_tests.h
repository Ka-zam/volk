...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    QA(VOLK_INIT_TEST(volk_32f_reciprocal_32f, test_params.make_tol(1e-3)))
    QA(VOLK_INIT_TEST(volk_32f_rsqrt_32f, test_params))
    QA(VOLK_INIT_TEST(volk_32f_invsqrt_32f, test_params.make_tol(1e-3)))
