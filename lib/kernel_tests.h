...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    QA(VOLK_INIT_TEST(volk_32f_average_power_32f, test_params.make_absolute(1e-5)))
    QA(VOLK_INIT_TEST(volk_32fc_average_power_32f, test_params.make_absolute(1e-5)))
