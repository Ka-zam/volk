...
std::vector<volk_test_case_t> init_test_list(volk_test_params_t test_params)
{
    ...
    volk_test_params_t test_params_recip(test_params.make_tol(1e-5));
    test_params_recip.add_float_edge_cases({-inf, inf, 0.f, -0.f });
    QA(VOLK_INIT_TEST(volk_32f_reciprocal_32f, test_params_recip))
