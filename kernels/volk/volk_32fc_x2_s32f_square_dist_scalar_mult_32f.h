                                                    ...
                                                    unsigned int num_points)
{
    ...
    calculate_scaled_distances(target, *src0, points, scalar, num_points - quarterPoints * 4);
}
                                                      ...
                                                      unsigned int num_points)
{
    ...
    for (; number < eighthPoints; number++) {
        ...
        float32x4_t result0 = vfmaq_f32(vmulq_f32(diffReal0, diffReal0), diffImag0, diffImag0);
        float32x4_t result1 = vfmaq_f32(vmulq_f32(diffReal1, diffReal1), diffImag1, diffImag1);
