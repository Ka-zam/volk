...
static inline void volk_32f_sin_32f_a_avx512f_var(float* sinVector,
                                                   const float* inVector,
                                                   unsigned int num_points)
{
    float* sinPtr = sinVector;
...
static inline void volk_32f_sin_32f_a_avx2_fma_var(float* bVector,
                                                   const float* aVector,
                                                   unsigned int num_points)
{
    float* bPtr = bVector;
...
static inline void volk_32f_sin_32f_a_avx2_var(float* bVector,
                                               const float* aVector,
                                               unsigned int num_points)
{
    float* bPtr = bVector;
...
static inline void volk_32f_sin_32f_a_sse4_1_var(float* bVector,
                                                  const float* aVector,
                                                  unsigned int num_points)
{
    float* bPtr = bVector;
...
static inline void volk_32f_sin_32f_u_avx512f_var(float* sinVector,
                                                   const float* inVector,
                                                   unsigned int num_points)
{
    float* sinPtr = sinVector;
...
static inline void
volk_32f_sin_32f_u_avx2_fma_var(float* bVector, const float* aVector, unsigned int num_points)
{
    float* bPtr = bVector;
    const float* aPtr = aVector;
...
static inline void volk_32f_sin_32f_u_avx2_var(float* bVector,
                                               const float* aVector,
                                               unsigned int num_points)
{
    float* bPtr = bVector;
...
static inline void volk_32f_sin_32f_u_sse4_1_var(float* bVector,
                                                  const float* aVector,
                                                  unsigned int num_points)
{
    float* bPtr = bVector;
